#!/usr/bin/env python3
"""
MTCR Agentic Automation Demo - Python Script Version
Converted from MTCR_Demo.ipynb

Author: Navid Broumandfar – Service Analytics, CHP

This script runs the complete MTCR demo pipeline:
- Tests LM Studio connection
- Processes sample MTCR data with AI
...
# Diagram 1: Current MTCR Process
nodes = [
    ("CRM", "CRM / TWD Data"),
    ("EXL", "MTCR Data.xlsm"),
    ("REV", "Manual Review"),
    ("KPIS", "KPIs / Tableau"),
    ("EMAIL", "Correction Emails"),
]
edges = [
    ("CRM", "EXL"),
    ("EXL", "REV"),
...
draw_flowchart(nodes, edges, "Current MTCR Process (Simplified)", layout_type="tree")

# Diagram 2: Agentic Automation Architecture
nodes = [
    ("SUB", "Sample Quality Review"),
    ("RAG", "RAG Context SOP"),
    ("LLM", "Local LLM"),
...
draw_flowchart(
    nodes,
    edges,
    "MTCR Agentic Automation Architecture (Local Prototype)",
    layout_type="tree",
)
...
draw_flowchart(
    nodes, edges, "MTCR Roadmap M1-M10 Done M11-M13 Future", layout_type="linear"
)
...
print("=" * 60)
print("RUNNING MTCR DEMO PIPELINE")
print("=" * 60)
...
print(f"  - Current_MTCR_Process_Simplified.png")
print(f"  - MTCR_Agentic_Automation_Architecture_Local_Prototype.png")
print(f"  - MTCR_Roadmap_M1-M10_Done_M11-M13_Future.png")
print(f"  - {result.get('log_path', 'N/A')}")
print("\n✅ MTCR Agentic Automation Demo completed successfully!")
print("=" * 60)
